          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('هل لديك استشارة فنية',style: TextStyle(color: Colors.white,fontSize: SizeConfig.scaleTextFont(14),fontFamily: 'Bahij'),),
                    Text('نقدم لك خدماتنا بما يتعلق باستشاراتك ونكون سعداء بتقديم المساعدة',textAlign: TextAlign.center,style: TextStyle(color: Colors.white,fontSize: SizeConfig.scaleTextFont(10),fontFamily: 'Bahij'),maxLines: 2,),
                    Container(
                      height: SizeConfig.scaleHeight(22) ,
                      margin: EdgeInsets.symmetric(
                        horizontal: SizeConfig.scaleWidth(21),
                      ),
                      child: ElevatedButton(onPressed: (){}, child: Text('أرسل استشارة',style: TextStyle(fontSize: SizeConfig.scaleTextFont(10),fontFamily: 'Bahij'),),
