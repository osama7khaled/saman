...
//TODO REFACTOR
                    Container  (
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.grey,fontFamily: 'Bahij',fontSize: SizeConfig.scaleTextFont(16)),
                    ...
                    CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => Container(
                          ...
                          child: Container(
                            width: SizeConfig.scaleWidth(95),
                              height: SizeConfig.scaleHeight(95),
                              child: Icon(Icons.person, size: SizeConfig.scaleWidth(60), color: Colors.white,))),
                    ),
                    Positioned(
  ...
  Future<bool> changePassword() async{
    ...
    bool success =  await UserApiController().resetPassword(context, oldPassword: _oldPasswordTextEditingController.text, newPassword: _newPasswordTextEditingController.text);
     if(success){
       Get.snackbar("نجاح", "تم تغيير كلمة المرور بنجاح", backgroundColor: Colors.green);
       Navigator.pop(context);
     }
     return success;
